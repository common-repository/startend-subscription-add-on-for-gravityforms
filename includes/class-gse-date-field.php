...
class GF_Field_Date_Picker extends GF_Field {

	public $type = 'gse_date_picker';

	public function get_form_editor_field_title() {
		return esc_attr__( 'STARTEND Date Picker', 'gravityforms' );
	}
...
GF_Fields::register( new GF_Field_Date_Picker() );
